    ...
    <div className="mx-40 max-500:mx-10">
      ...
      <main className="flex justify-between">
        <section className="w-[60rem]">
          <h1 className="font-bold text-8xl w-[55rem] dark:text-[#AEBCCF] max-500:text-5xl">
          ...
          <p className="w-[46rem] my-12 text-2xl dark:text-white max-500:w-[27rem]">
            {lang == "tr"
          ...
          <nav className="flex items-center max-500:flex-wrap max-500:w-[30rem]">
            ...
            <a
              ...
              className="text-[#3730A3] mr-14 max-500:mr-0 border-[#3730A3] px-9 py-4 border text-2xl rounded-2xl dark:bg-[#383838] dark:border-[#E1E1FF] dark:text-[#E1E1FF] max-500:w-[12.5rem]"
            >
              <button className="flex items-center">
